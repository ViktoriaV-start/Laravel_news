<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.source.index')?'active':'' }}" href="{{ route('admin.source.index') }}">

                    <svg width="16" height="16" fill="currentColor" class="bi bi-binoculars mb-2" viewBox="0 0 16 16">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.ajax')?'active':'' }}" href="{{ route('admin.ajax') }}">
